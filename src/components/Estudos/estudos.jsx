...
const Estudos = () => {return (
    <div className="estudos">
      ...
      <div className={"jsversusruby"}>
       ...
       <br />
        Aprendi que no Ruby as chamadas de métodos não precisam sererem feitas em um objeto específico, como no Java. Os métodos definidos 
...
<p id={"texto"}>Estudei sobre o FlexBox em janeiro de 2023. Eu via que meus projetos não ficavam com um formato tão legal
  ...
  O conceito de Flexbox mudou o minha mente sobre frontend, por que não é apenas jogar uma div , mas sim entender a estrutura do seu site. Comecei a me 
 ...
 Neste portifólio utilizei conceitos de Flexbox e pretendo com o tempo deixar ele responsivo para tamanhos menores.
      ...
      <div className={"imgJava"}></div>
       ...
       <p id={"texto"}>Aparentemente parece ter nada a ver um versus entre Java e React. E realmente não tem. Porém, criei está seção para 
        ...
        e um curso dado pelo professor Nélio Alves na Udemy foi extremamente rico para mim. Na Udemy conheci o Redux para gerenciamento de estado. Embora 
        tendo achado o Redux muito verboso, achei ele melhor do que a forma como tentava gerenciar os estados antes.
        <br />
